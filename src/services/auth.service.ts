...
export class AuthService {
    static async login(data: any) {
        ...
        if (!email || !password) {
            throw new AppError(ERROR_MESSAGES.AUTH.MISSING_CREDENTIALS, HTTP_STATUS.BAD_REQUEST);
        }
        ...
        throw new AppError(ERROR_MESSAGES.AUTH.INCORRECT_CREDENTIALS, HTTP_STATUS.UNAUTHORIZED);
    }
}
